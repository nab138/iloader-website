...
export default function PairingFile() {
  return (
    <>
      <Seo
        title="iloader Pairing File Guide - Official Instructions"
        description="Official iloader pairing file guide for StikDebug and Protokolle."
        canonical="https://iloader.app/pairing"
            ...
            <div>
              ...
              <ol>
                ...
                <li>
                  ...
                  device appears wirelessly that will work too) and click
                  refresh. Your device should appear in the list.
                </li>
                <li>
                  Click "
        ...
        <section className="workspace-section">
          ...
          <div className="glass-card">
            ...
            <p>
              ...
              iDevice as easy as possible. Learn more on the iloader home page.
            </p>
